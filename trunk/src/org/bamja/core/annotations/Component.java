...
/**
 * Describes on of the components of a bundle in the activator class, which
 * should managt by bamaj automatically.
 * <p>
 * Beschreibt in der Activatorklasse eine der Komponente eines Bundles, welche
 * automatisch von bamja verwaltet werden soll.
 * 
...
public @interface Component {
    ...
    /**
     * The supported types for the instantiation of a component.
     * 
     * @author Jens Kutzsche
     * @since Version: 0.2.0 (16.02.2006)
     */
    enum InstantiationType {
        SINGLETON, ONE_FOR_BUNDLE
    }

    /**
     * Is the annotation attribut <tt>className</tt> for the <tt>Class</tt>of
     * the Component.
     * 
    ...
    /**
     * The type for the instantiation of this component.
     * 
     * @return On of the type from the enumeration <tt>InstantiationType</tt>.
     */
    InstantiationType instantiationType() default InstantiationType.SINGLETON;

    boolean startAutomatically() default false;
}
