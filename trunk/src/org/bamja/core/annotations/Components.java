...
/**
 * Collect several components for automatically manage in an activator. 
 * 
...
public @interface Components {
    /**
     * The default annotation attribute for an array of <tt>Component</tt>. 
     * 
     * @return The components for automatically manage.
     */
    Component[] value();
}
