 ...
 * @since Version: 0.1.0 (21.02.2006)
 */
public class InstanceFactoryImpl implements InstanceFactory {
     ...
     * @param reference
     */
    public InstanceFactoryImpl(BundleContext context, ServiceReference reference) {
        assert context != null;
    ...
    public Object getInstance() {
        Object currentObject = this.context.getService(this.reference);
        return currentObject;
    }

    public void ungetInstance(Object instance) {
