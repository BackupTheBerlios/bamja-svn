/*
 * IREAPContext.java -- TODO Insert a short describtion of this file. 
...
public interface IREAPContext {

	void createNew(IWorkbenchPart part);

	void createNew(IWorkbenchPart part, String fieldName);

	void delete(IWorkbenchPart part);

	// void delete(IWorkbenchPart part, Class<?> subclass);

	void delete(IWorkbenchPart part, String fieldName);

	void executeDatabaseAcces(IWorkbenchPart part, String id, Object... args)
			throws InstantiationException, IllegalAccessException;

	List executeDatabaseAcces(String id, Object... args)
			throws InstantiationException, IllegalAccessException;

	void save(IWorkbenchPart part);
}
