/*
 * AbstractORMManager.java -- TODO Insert a short describtion of this file.
...
public abstract class AbstractORMManager implements IORMManager {
	...
	protected Set<Class<?>>			persistentClasses		= null;

	protected Properties			properties				= null;

	protected String				username				= null;

	public AbstractORMManager() {
	}

	@Override
	public final void addPersistentClass(final Class<?> entity) {
		if (persistentClasses == null) {
			persistentClasses = new HashSet<Class<?>>();
		}
		persistentClasses.add(entity);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.reap.core.IORMManager#setConnectionDriver(java.lang.String)
	 */
	@Override
	public final void setConnectionDriver(final String driver) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.reap.core.IORMManager#setConnectionURL(java.lang.String)
	 */
	@Override
	public final void setConnectionURL(final String url) {
		connectionURL = url;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.reap.core.IORMManager#setDialect(java.lang.String)
	 */
	@Override
	...
	@Override
	public final void setPersistentClasses(final Set<Class<?>> classes) {
		persistentClasses = classes;
	}
