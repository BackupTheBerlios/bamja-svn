/*
 * IORMManager.java -- TODO Insert a short describtion of this file.
...
public interface IORMManager {
	...
	void addPersistentClass(Class<?> entity);

	EntityManager getEntityManager();

	// boolean isDialectSetInSystemProperties();

	// boolean isJDBCDriverSetInSystemProperties();

	void setConnectionDriver(String driver);
	...
	void setPersistentClasses(Set<Class<?>> classes);
