/*
 * DriverConfig.java -- TODO Insert a short describtion of this file. 
...
public class DriverConfig {
	...
	private final boolean	defaultDriver;
	private final String	driver;

	public DriverConfig(final String driver, final boolean defaultDriver) {
		this.driver = driver;
	...
	/**
	 * @return the defaultDriver
	 */
	public final boolean isDefaultDriver() {
