/*
 * DatabaseAccess.java -- TODO Insert a short describtion of this file.
...
public class DatabaseAccess {
	...
	private final Class<? extends IDatabaseAccess>	databaseAccessClass;
	private final String							id;
	private final boolean							withoutArgumentsOk;

	public DatabaseAccess(final String id, final boolean withoutArgumentsOk,
			final Class<? extends IDatabaseAccess> databaseAccessClass) {
		this.id = id;
		this.withoutArgumentsOk = withoutArgumentsOk;
		this.databaseAccessClass = databaseAccessClass;
	}

	/**
	 * @return the listDatabaseAccessClass
	 */
	public final Class<? extends IDatabaseAccess> getDatabaseAccessClass() {
	...
	/**
	 * @return the withoutArgumentsOk
	 */
	public final boolean isWithoutArgumentsOk() {
		return withoutArgumentsOk;
	}

	public final IDatabaseAccess newInstance() throws InstantiationException,
			IllegalAccessException {
		return databaseAccessClass.newInstance();
	}
}
