/*
 * PersistenceConfigConstants.java -- TODO Insert a short describtion of this file. 
...
public interface PersistenceConfigConstants {
	String	DATABASE					= "database";
	String	DATABASE_SYSTEM				= "databaseSystem";
	String	HOST						= "host";
	String	JDBC_DRIVER					= "jdbcDriver";
	String	JDBC_DRIVER_FREE_SETTING	= "jdbcDriverManuelSetting";
	String	ORM_MANAGER					= "ormManager";
	String	PASSWORD					= "password";
	String	PORT						= "port";
	String	SQL_DIALECT					= "sqlDialect";
	String	SQL_DIALECT_FREE_SETTING	= "sqlDialectManuelSetting";
	String	USE_SYSTEM_PROPERTIES		= "useSystemProperties";
