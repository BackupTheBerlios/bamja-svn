/*
 * ModelObject.java -- TODO Insert a short describtion of this file. 
...
public class ModelObject {
	...
	public ModelObject(final Object object, final ModelClass modelClass) {
		this.object = object;
	...
	public final IObservable getObservable(final String property) {
		// if (!modelClass.hasProperty(property)) {
		// throw new IllegalArgumentException("The property " + property
		// + "doesn't exist in class " + modelClass.getName() + "!");
		// }
		final IObservable observable = observables.get(property);
		// if (observable == null) {
		// observable = modelClass.getObservable(property, object);
		// observables.put(property, observable);
		// }
		return observable;
	}
}
