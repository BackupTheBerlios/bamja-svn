/*
 * GUIBindingTypes.java -- TODO Insert a short describtion of this file.
...
public enum GUIBindingTypes {
	BACKGROUND, EDITABLE, ENABLED, FONT, FOREGROUND, ITEMS, JFACEINPUT,
	JFACESINGLESELECTION, MAX, MIN, SELECTION, SINGLESELECTIONINDEX, TEXT,
	TEXTFOCUSOUT, TEXTMODIFY, TEXTNONE, TOOLTIPTEXT, VISIBLE;
}
